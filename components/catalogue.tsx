...
import catalogDark from "../public/assets/icons/catologDark.svg";

export default function Catalogue() {
    return <div className=" min-w-[300px] pl-[40px]  py-[40px] ">
        <div className='flex text-center items-center  '>
             <Image src={catalogDark} alt={"catalog"} width={26} height={26} className="mr-[19px]" />
    ...
    <div className=' text-[16px] leading-[20px]  font-montserrat font-medium pt-[24px] '>
            <div className='flex text-center items-center  '>
                <Image src={catalogDark} alt={"catalog"} width={24} height={24} className="mr-[8px]" />
